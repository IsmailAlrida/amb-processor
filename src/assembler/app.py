...
class AssemblerWindow(QtWidgets.QMainWindow):
    ...
    def _build_ui(self) -> None:
        ...
        self.reg_table.setGridStyle(QtCore.Qt.PenStyle.SolidLine)
        ...
        self.mem_table.setGridStyle(QtCore.Qt.PenStyle.SolidLine)
...
Comments: // ; #
    ...
    def _apply_style(self) -> None:
        style_path = Path(__file__).parent / "assets" / "amb.qss"
        try:
